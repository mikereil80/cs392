...
int main(int argc, char *argv[]){
	...
	int client_socket, bytes,recvd, ip_conversion, retval=EXIT_SUCCESS;
	...
	memset(&server_addr, 0, addrlen); // Zero out the structure
	
	// Convert Character string int network address.
